...
CREATE TABLE players (
    ...
    details TEXT,
    photo_url TEXT DEFAULT NULL -- Added photo_url
);

-- Ensure photo_url column exists for existing databases
ALTER TABLE players ADD COLUMN IF NOT EXISTS photo_url TEXT DEFAULT NULL;
